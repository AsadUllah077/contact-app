        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h1 class="font-semibold">Update Business</h1>
                    <form action="{{ route('business.update', $business->id) }}" method="POST" class="p-4 rounded mx-auto">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-6 gap-4">
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <input type="text" name="contact_email" value="{{ old('contact_email', $business->contact_email) }}"
